...
namespace AB
{
    public partial class Company : Form
    {
        ...
        {
            string sParams = "";
            string sResult = apic.loadData("/api/driver/company/get_all", sParams, "", "", Method.GET, true);
        ...
        {
            AddCompany.isSubmit = false;
            AddCompany frm = new AddCompany();
            frm.ShowDialog();
            if (AddCompany.isSubmit)
            {
                bg();
            }
        }
        ...
        private void repositoryItemButtonEdit1_Click(object sender, EventArgs e)
        {
            ...
            EditCompany.isSubmit = false;
            EditCompany frm = new AB.EditCompany(id);
            frm.txtName.Text = companyName;
            frm.ShowDialog();
            if (EditCompany.isSubmit)
            {
                bg();
            }
        }

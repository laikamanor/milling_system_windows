...
namespace AB
{
    public partial class manualReceive_Details : Form
    {
        public manualReceive_Details(string itemCode, string uom, bool isAdd)
        {
            InitializeComponent();
            gItemCode = itemCode;
            gUom = uom;
        ...
        private void manualReceive_Details_Load(object sender, EventArgs e)
        {

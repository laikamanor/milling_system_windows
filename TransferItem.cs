...
namespace AB
{
    public partial class TransferItem : Form
    {
        ...
        public void loadData()
        {
            ...
            string sParams = sBranch + sFromDate + sToDate + sFromTime + sToTime + sFromWhse + sToWhse + sDocStatus + sPlant + sIsBranchtoBranch;
            ...
            if (!string.IsNullOrEmpty(sResult) && sResult.Substring(0, 1).Equals("{"))
            {
                ...
                if (IsHandleCreated)
                {
                    gridControl1.Invoke(new Action(delegate ()
                    {
                        ...
                        {
                            "transdate", "reference", "from_whse", "to_whse", "transtype", "platenum", "shift", "driver", "vessel", "agi_truck_scale", "chti_truck_scale", "remarks","is_branch_to_branch","inter_whse","id", "rec_reference","rec_transdate"
                        };
                        ...
                        foreach (GridColumn col in gridView1.Columns)
                        {
                            ...
                            col.Visible = fieldName.Equals("transdate") || fieldName.Equals("reference") || fieldName.Equals("from_whse") || fieldName.Equals("to_whse") || fieldName.Equals("transtype") || fieldName.Equals("rec_reference") || fieldName.Equals("rec_transdate") || fieldName.Equals("platenum") || fieldName.Equals("shift") || fieldName.Equals("agi_truck_scale") || fieldName.Equals("chti_truck_scale") || fieldName.Equals("vessel") || fieldName.Equals("driver") || fieldName.Equals("remarks");

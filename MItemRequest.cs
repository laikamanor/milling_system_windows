...
namespace AB
{
    public partial class MItemRequest : Form
    {
        public MItemRequest()
        {
            InitializeComponent();
        ...
        private void MItemRequest_Load(object sender, EventArgs e)
        {
        ...
        {
            MItemRequest_Dialog.isSubmit = false;
            MItemRequest_Dialog frm = new MItemRequest_Dialog(jaSelected);
            frm.ShowDialog();
            isSubmit = true;
            //this.Hide();
            bg(backgroundWorker1);
                    ...
                    if (!string.IsNullOrEmpty(itemCode.Trim()))
                    {
                        ...
                        else
                        {
                            try
                            {
                                ...
                                MItemRequest_Details frm = new MItemRequest_Details(itemCode, uom, true);
                                frm.ShowDialog();
                                this.Focus();

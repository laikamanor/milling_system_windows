...
namespace AB
{
    public partial class AddTruck : Form
    {
        ...
        {
            TextBox[] txts = { txtPlate_Num, txtTruck_Model, txtTruck_Type };
        ...
        public void insert(TextBox[] txts)
        {
            ...
            string sResult = apic.loadData("/api/trucks/add", "", "application/json", joBody.ToString(), RestSharp.Method.POST, true);

...
namespace AB {
    ...
    public class finalSales : ReportClass {
    ...
    public class CachedfinalSales : Component, ICachedReport {
        
        public CachedfinalSales() {
        }

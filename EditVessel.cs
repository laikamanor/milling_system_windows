...
namespace AB
{
    public partial class EditVessel : Form
    {
        public EditVessel(int id)
        {
            InitializeComponent();
            selectedID = id;
        }
        ...
        private void EditVessel_Load(object sender, EventArgs e)
        {
        ...
        public void updateVessel(string companyName)
        {
            JObject joBody = new JObject();
            joBody.Add("name", companyName.Trim());
            string sResult = apic.loadData("/api/vessel/update/", selectedID.ToString(), "application/json", joBody.ToString(), Method.PUT, true);

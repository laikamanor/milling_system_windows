...
namespace AB
{
    public partial class EditCompany : Form
    {
        ...
        public void updateCompany(string companyName)
        {
            ...
            string sResult = apic.loadData("/api/driver/company/update/", selectedID.ToString(), "application/json", joBody.ToString(), Method.PUT, true);
